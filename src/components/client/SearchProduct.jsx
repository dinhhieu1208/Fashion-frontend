...
export const SearchProduct = () => {
  ...
  const handleSubmit = (event) => {
    ...
    navigate(`/product?search=${event.target.keyword.value}`);
  };

  return (
    <form className="relative hidden lg:flex items-center border border-gray-300 rounded-full px-3 h-10 w-72" onSubmit={handleSubmit}>
      <img
        src={icon_search}
        alt="Search"
