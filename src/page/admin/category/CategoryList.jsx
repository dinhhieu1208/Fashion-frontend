  ...
  return (
    <>
      <div className="p-0 sm:p-4 min-w-screen">
        <div className="mb-[20px] text-[44px]">Danh sánh danh mục</div>
        <div className="mb-[20px] sm:flex">
          <form action="" className="w-[360px] h-[44px] flex items-center">
            ...
            <input type="text" placeholder="Search category name..." className="w-full h-full pr-[30px] pl-[40px] py-[20px] rounded-[10px] shadow-sm" />
          </form>

          <div className="ml-[20px] sm:mt-0 mt-[10px]">
            <select name="" id="" defaultValue={"filter"} className="w-[130px] h-[44px] p-2 bg-white rounded-[10px]">
